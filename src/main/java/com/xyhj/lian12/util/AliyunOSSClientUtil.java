...
public class AliyunOSSClientUtil {
    ...
    @Value("${oss.acess_key_id}")
    public static String ACCESS_KEY_ID;
    //阿里云API的密钥Access Key Secret
    @Value("${oss.Aacess_key_secret}")
    ...
    public static void main(String[] args) {
        //初始化OSSClient
        OSSClient ossClient=new OSSClient(ENDPOINT,"LTAI4hS5QVrXRCNz", "P6a23sr5JnMjRJogIGpqgqDAvbNVka");



        Date expiration = new Date(new Date().getTime() + 3600l * 1000 * 24 * 365 * 10);
        String url = ossClient.generatePresignedUrl("test-auth-image", "timg.jpeg", expiration).toString();
        //上传文件
        /*String files="/Users/manxiaoqiang/Downloads/timg.jpeg";
    ...
    public static Map<String, String> getStsToken(String accessKeyId, String accessKeySecret) {
        System.out.println("ACCESS_KEY_ID" + ACCESS_KEY_ID);
        Map<String, String> map= new HashMap<>();
        String endpoint = "sts.aliyuncs.com";
        String roleArn = "acs:ram::1423127737985773:role/test-app";
        String roleSessionName = "test-app";
        String policy = "{\n" +
                "    \"Version\": \"1\", \n" +
                "    \"Statement\": [\n" +
                "        {\n" +
